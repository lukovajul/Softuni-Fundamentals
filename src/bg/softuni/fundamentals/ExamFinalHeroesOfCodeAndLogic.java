...
public class ExamFinalHeroesOfCodeAndLogic {
            ...
            switch (command){
                ...
                case "TakeDamage":
                    ...
                    if (heroes.get(heroName)[0] >0){
                        ...
                        System.out.println(String.format("%s was hit for %d HP by %s and now has %d HP left!", heroName, amount, attacker, heroes.get(heroName)[0]));
                    }else{
