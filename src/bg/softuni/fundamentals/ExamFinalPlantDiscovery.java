...
public class ExamFinalPlantDiscovery {
    ...
    public static void main(String[] args) {
        ...
        for (int i = 0; i<n; i++){
            ...
            plantsByName.put(p.getName(), p); //na pozicia imeto na planta slagame samia plant; suzdavame i getter
        }
        ...
        plantsByName.values().stream().sorted((a,b) -> {
